...
| Copy | Words |
| --- | ---: |
| Read the camp report. | 4 |
| See the next obstacle and the current weather. | 8 |
| Spend one resource. | 3 |
| Every route changes warmth, supplies, or Mara's trust. | 8 |
| Reach an ending. | 3 |
| Your six decisions lead to one of four written conclusions. | 10 |
...
| --- | --- |
| The six-decision play session | run |
| A decision | choice |
| The available direction | route |
| A stage | camp |
| The fixed content key | weather seed |
| Stored unfinished progress | saved run |
| Paid content | complete edition |
| No-save sample | demo |
